...
export default function PipelinePage({ perms={}, platformLogo=null, navOrder=null }) {
  ...
  return (
    <>
      <Head><title>Genesis Agent v1.6 — KANSO</title></Head>
      ...
      <div style={s.page}>
        ...
        <div style={s.main}>
          <div style={s.topBar}>
            <div>
              <div style={s.topTitle}>Genesis Agent <span style={{fontSize:12,fontWeight:500,color:'#94A3B8',marginLeft:6}}>v1.6</span></div>
